...
all_filtered$TreatmentDrugCategorized <- as.factor(all_filtered$TreatmentDrugCategorized)
...
#ASSUMPTION 1
all(all_filtered_imputed$TreatmentDrugCategorized %in% c(0,1))
...
plot(roc_curve,
     ...
     xlim = c(0, 1),
     ylim = c(0, 1),
     xlab = "1 - Specificitet (False Positive Rate)",
     ylab = "Sensitivitet (True Positive Rate)",
     asp = 1)

auc_value <- auc(roc_curve)
text(0.6, 0.2, paste("AUC =", round(auc_value, 2)), col = "blue", cex = 1.2)
points(0, 1, col = "red", pch = 19, cex = 1.5)
text(0, 1, "Perfekt klassifikator", pos = 4, col = "red", cex = 0.9)
